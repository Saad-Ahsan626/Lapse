...
abstract final class Motion {
  ...
  static const pressOpacity = Duration(milliseconds: 150);
  static const chip = Duration(milliseconds: 180);

  static const fieldFade = Duration(milliseconds: 120);
  static const fade = Duration(milliseconds: 200);
  static const snap = Duration(milliseconds: 220);
  ...
  static const spring = Duration(milliseconds: 360);
